...
extension View {
  ...
  public func sheet<State, Action, Content: View>(
    ...
    onDismiss: (() -> Void)? = nil,
    @ViewBuilder content: @escaping (_ store: Store2<State, Action>) -> Content
  ) -> some View {
  ...
  public func sheet<State, Action, DestinationState, DestinationAction, Content: View>(
    ...
    onDismiss: (() -> Void)? = nil,
    @ViewBuilder content: @escaping (_ store: Store2<DestinationState, DestinationAction>) -> Content
  ) -> some View {
    self.presentation(
